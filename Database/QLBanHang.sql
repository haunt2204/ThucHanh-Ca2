...
CREATE TABLE `hoadon` (
  ...
  KEY `MaSP_idx` (`MaSP`),
  CONSTRAINT `MaSP` FOREIGN KEY (`MaSP`) REFERENCES `sanpham` (`idSanPham`)
...
INSERT INTO `loaisp` VALUES (1,'Nước giải khát',NULL),(2,'Cafe',NULL),(3,'Rượu',NULL),(4,'Bánh ngọt',NULL);
...
CREATE TABLE `sanpham` (
  ...
  CONSTRAINT `LoaiSP` FOREIGN KEY (`LoaiSP`) REFERENCES `loaisp` (`idLoaiSP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-16 15:21:06
